...
import TredingComponent from '../../src/pages/Main/components/Trending';
import CardComponent from '../../src/pages/Main/components/CardMovies';
import GenresComponent from '../../src/pages/Main/components/Genres';
import MovieComponent from '../../src/pages/Movie/MovieComponent';
import ProfileComponent from '../../src/pages/Profile/ProfileComponent';
...
it('renders correctly TredingComponent', () => {
  const tree = renderer
    .create(
      <Provider store={store}>
        <TredingComponent data={fakeData} navigation={fakeNavigation} />
      </Provider>,
    )
    .toJSON();
...
it('renders correctly CardComponent', () => {
  const tree = renderer
    .create(
      <Provider store={store}>
        <CardComponent data={fakeData} navigation={fakeNavigation} />
      </Provider>,
    )
    .toJSON();
  expect(tree).toMatchSnapshot();
...
it('renders correctly GenresComponent', () => {
  const tree = renderer
    .create(
      <Provider store={store}>
        <GenresComponent data={fakeData} navigation={fakeNavigation} />
      </Provider>,
    )
    .toJSON();
  expect(tree).toMatchSnapshot();
...
it('renders correctly MovieComponent', () => {
  const tree = renderer
    .create(
      <Provider store={store}>
        <MovieComponent detailMovie={fakeMovie} navigation={fakeNavigation} />
      </Provider>,
    )
    .toJSON();
  expect(tree).toMatchSnapshot();
...
it('renders correctly ProfileComponent', () => {
  const tree = renderer
    .create(
      <Provider store={store}>
        <ProfileComponent data={fakeUser} navigation={fakeNavigation} />
      </Provider>,
    )
    .toJSON();
  expect(tree).toMatchSnapshot();
